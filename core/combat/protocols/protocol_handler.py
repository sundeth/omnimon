...
class ProtocolHandler:
    ...
    def __init__(self, protocols_dir: Optional[str] = None):
        ...
        if protocols_dir is None:
            # Default to protocols folder in same directory as this file
            self.protocols_dir = os.path.join(os.path.dirname(__file__))
        else:
            self.protocols_dir = protocols_dir
        
        self.battle_protocols_dir = os.path.join(self.protocols_dir, 'battle')
        self._loaded_protocols: Dict[str, ProtocolDefinition] = {}
    
    def discover_protocols(self, protocol_type: str = 'battle') -> List[str]:
        """
    ...
    def load_protocol(self, protocol_name: str, protocol_type: str = 'battle') -> Optional[ProtocolDefinition]:
        """
