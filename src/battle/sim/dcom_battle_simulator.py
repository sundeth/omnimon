...
class DComBattleSimulator:
    ...
    def simulate_with_device(self, player_digimon: Digimon, timeout: float = 30.0) -> Optional[BattleResult]:
        ...
        try:
            ...
            # Real devices use 0-based attack sprite IDs,
            # Omnipet uses 1-based (0=no sprite), so add 1 after receiving.
            opponent_digimon.shot1 += 1
            opponent_digimon.shot2 += 1
            
            # Store opponent data so callers can access it for team setup
            self.opponent_digimon = opponent_digimon
